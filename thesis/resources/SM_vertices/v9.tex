...
\begin{tikzpicture}[]
    ...
    \node [dot] at (cent) {};
    \diagram* {
    (a) -- [boson, edge label'=\(W\), near start] (cent) -- [boson, edge label'=\(W|\text{Z}^{0}/\gamma\), near end] (b),
    (c) -- [boson, edge label=\(W\), near start] (cent) -- [boson, edge label=\(W|\text{Z}^{0}/\gamma\), near end] (d),
    };
    \end{feynman}
\end{tikzpicture}
