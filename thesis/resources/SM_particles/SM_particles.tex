...
\tikzset{%
  ...
  bottomlabel/.style = { label, below=.5em, anchor=north },
        force/.style = { rotate=-90,scale=0.50 },
        round/.style = { rounded corners=2mm },
       legend/.style = { right,scale=0.50 },
...
\newcommand\particle[7][white]{%
  \begin{tikzpicture}[x=1cm, y=1cm]
    ...
    \ifstrempty{#6}{}{\node at(0.89,-0.09)  [nosep,scale=0.23] {#6};}
    \ifstrempty{#5}{}{\node at(0.91,-0.91)  [nosep,scale=0.23] {#5};}
    \ifstrempty{#4}{}{\node at(0.1,-0.13)  [nosep,anchor=west,scale=0.35]{#4};}
    \ifstrempty{#3}{}{\node at(0.1,-0.85) [nosep,anchor=west,scale=0.42] {#3};}
...
\begin{tikzpicture}[x=1.2cm, y=1.2cm]
  ...
  \node at(0, 0)   {\particle[gray!20!white]
                   {u}        {up}       {$2.16$ MeV}{1/2}{$2/3$}{R/G/B}};
  \node at(0,-1)   {\particle[gray!20!white]
                   {d}        {down}    {$4.67$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(0,-2)   {\particle[gray!20!white]
                   {e}        {electron}       {$511$ keV}{1/2}{$-1$}{}};
  \node at(0,-3)   {\particle[gray!20!white]
                   {$\nu_{\text{e}}$}    {e neutrino}         {$<1.1$ eV}{1/2}{}{}};
  \node at(1, 0)   {\particle
                   {c}        {charm}   {$1.27$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(1,-1)   {\particle 
                   {s}        {strange}  {$93.4$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(1,-2)   {\particle
                   {$\mu$}      {muon}         {$105.7$ MeV}{1/2}{$-1$}{}};
  \node at(1,-3)   {\particle
                   {$\nu_\mu$}  {$\mu$ neutrino}    {$<190$ keV}{1/2}{}{}};
  \node at(2, 0)   {\particle
                   {t}        {top}    {$172.7$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(2,-1)   {\particle
                   {b}        {bottom}  {$4.18$ GeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(2,-2)   {\particle
                   {$\tau$}     {tau}          {$1.777$ GeV}{1/2}{$-1$}{}};
  \node at(2,-3)   {\particle
                   {$\nu_\tau$} {$\tau$ neutrino}  {$<18.2$ MeV}{1/2}{}{}};
  \node at(3,-3)   {\particle[orange!20!white]
                   {W$^{\hspace{-.1ex}\scalebox{.5}{$\pm$}}$}
                                {}              {$80.38$ GeV}{1}{$\pm1$}{}};
  ...
  \node at(5,0)    {\particle[gray!50!white]
                   {H}        {Higgs}              {$125.25$ GeV}{0}{}{}};

  \node at(4.25,-0.5) [force]      {strong nuclear force (color)};
  \node at(4.85,-1.45) [force]    {electromagnetic force (charge)};
  \node at(5.45,-2.35) [force] {weak nuclear force (weak isospin)};

  \draw [<-] (2.5,0.3)   -- (2.7,0.3)          node [legend] {charge};
  \draw [<-] (2.5,0.15)  -- (2.7,0.15)         node [legend] {colors};
  \draw [<-] (2.08,0.22) -- (2.3,0) -- (2.7,0) node [legend]   {mass};
