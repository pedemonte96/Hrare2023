...
\end{small}
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/pt_model_phi.png}
            \caption{\footnotesize (a)}
        \end{subfigure}%
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/residuals_model_phi.png}
            \caption{\footnotesize (b)}
        \end{subfigure}%\begin{subfigure}[t]{0.50\mylength}\baselineskip      
        \vskip\baselineskip
        \vspace*{-0.1cm}
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/pt_model_omega.png}
            \caption{\footnotesize (c)}
        \end{subfigure}%
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/residuals_model_omega.png}
            \caption{\footnotesize (d)}
        \end{subfigure}%\begin{subfigure}[t]{0.50\mylength}\baselineskip    
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/pt_model_d0star2.png}
            \caption{\footnotesize (a)}
        \end{subfigure}%
        \begin{subfigure}[t]{0.50\mylength}
            \centering
            \includegraphics[width=0.45\mylength]{resources/plots/residuals_model_d0star2.png}
            \caption{\footnotesize (b)}
        \end{subfigure}%\begin{subfigure}[t]{0.50\mylength}\baselineskip       
        \vskip\baselineskip
        \vspace*{-0.1cm}
...
\begin{table}[!ht]
    ...
    \multirow{2}{*}{ggH}&\multirow{2}{*}{tau-like}  &no e/$\mu$ with $\pT$ > 10 GeV & \multirow{2}{*}{39.54 (2018)}\\
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        \end{tabular}
    \caption{Degrees of freedom and $\chi^2$/dof for each decay mode and polynomial type used to model the background gamma-meson mass spectrum $M_{\gamma, M}$.}
    \label{tab:bkg_polynomials}
\end{table}

\todo{include sig+bkg model plots}

\todo{discuss plots}

\section{Estimated results}\label{sec:results}

The expected upper limits on the branching fractions are set at 95\% confidence level (CL). For this computation, the Combine tool is employed with the \verb+AsymptoticLimits+ method \cite{CMS:Combine}. \todo{explain intuitively how the limit is computed: only the fitted functions are used, that is somewhat proportional to the are under the curve like s/sqrt(s+b), etc.} Table \ref{tab:results} reports the expected upper limits on the branching ratios.
...
\todo{talk about MVA, data-MC corrections, bias study in background polynomials, and what are next steps before unblinding data (systematics, other production modes...)}
