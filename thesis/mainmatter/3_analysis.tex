...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.50\mylength}
        \centering
        \includegraphics[width=0.45\mylength]{resources/plots/D0Star_3body_fit_SGN_MH_sliced.png}
        \caption{\footnotesize (d)}
    \end{subfigure}%\begin{subfigure}[t]{0.50\mylength}\baselineskip
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.50\mylength}
        \centering
        \includegraphics[width=0.45\mylength]{resources/plots/D0Star_3body_fit_BKG_MH_sliced.png}
        \caption{\footnotesize (d)}
    \end{subfigure}%\begin{subfigure}[t]{0.50\mylength}\baselineskip
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|l|C{3cm}|C{3cm}|c|}
        ...
        $\text{H}\decaysto D^{*0}\gamma$ 2-body &$11.19 \times 10^{-3}$ &\multirow{2}{*}{-}       &\multirow{2}{*}{-}  \\
...
\todo{Comment results. luminosity atlas, phi channel of atlas is the 2body decay. remove of the table but talk about it.}
...
\begin{myitemlist}
    ...
    \item[Data - MC corrections:] Simulated signal and background samples should be corrected for various effects through reweighting procedures. This is relevant because the signal is used in the final fit estimation, while the background MC can be used for the training of the MVA discriminant earlier mentioned. \todo{explain better}
\iffalse
    \todo{
