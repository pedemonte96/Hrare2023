...
\setlength{\parskip}{0.3em} %paragraph separation
...
\pagestyle{empty}
\include{mainmatter/0000_frontpage}
\newpage
\thispagestyle{empty}
\mbox{}
\newpage
...
%\afterpage{\blankpage}
\include{mainmatter/000_acknowledgements}
\setlength{\parskip}{0.3em}
\include{mainmatter/00_abstract}
...
\include{mainmatter/0_intro}
\newpage \thispagestyle{empty}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\mainmatter
\include{mainmatter/1_motivation}
\include{mainmatter/2_theory}
...
\appendix
\include{mainmatter/99_1_appendix}
