...
parser.add_argument("-c", "--codeNum", type=int, required=True, help="Input the model name (e.g. BDTG_var1_var2).")
...
if options.modelName == "RECO":
    ...
    '''.format(modelName=options.modelName, numVarsTotal=getNumVarsExtra(options.modelName, options.codeNum) + 8)
