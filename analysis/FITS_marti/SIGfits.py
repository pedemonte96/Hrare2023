...
def fitSig(tag, mesonCat, year, date):

    print("Main fitSignal")

    data_full = getHisto(200*10, 0., 200., date, numDict[mesonCat], tag, mesonCat, mesonLatex[mesonCat], year)
...
def fitBkg(tag, mesonCat, year, date):

    print("Main fitBackground")
    ...
    canvas.SaveAs("~/public_html/fits/{}_fit_BKG.png".format(mesonCat))


if __name__ == "__main__":
    print("Main SGNfits")

    #fitSig('GFcat', 'D0StarCat', 2018, "JUN07")
    #fitSig('GFcat', 'Phi3Cat', 2018, "JUN07")

    print("Main BKGfits")

    #fitBkg('GFcat', 'D0StarCat', 2018, "MAY31")
    #fitBkg('GFcat', 'Phi3Cat', 2018, "MAY30")
