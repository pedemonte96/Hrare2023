...
ROOT.gSystem.Load("/home/submit/pdmonte/CMSSW_10_6_27/src/Hrare2023/analysis/MissingDics/MissingDics.so")
...
def SwitchSample(argument,year):
    ...
    switch = {
        ...
        #
        #1037: (dirLocalNEW2+"ggh-homegagamma-powheg_03_test2"+"/NANOAOD_03_test2",48580*0.892), #xsec = 3*9.426E-02 (xsec*ggH) * BR(HomegaGamma)=1 BR(omega->pipipi0)=89.2
        ...
        1040: (dirLocalNEW2+"ggh-hD0StarKmPiPPi0gamma-powheg"+"/NANOAOD_03_test5", 48580*0.1443),
        1041: (dirLocalNEW2+"ggh-hD0Stargamma-powheg"+"/NANOAOD_03_test5", 48580*0.03962),
