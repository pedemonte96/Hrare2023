...
hSGN = df.Define("scale", "w*lumiIntegrated").Histo1D(("hist", "#phi three mass, reconstruction", 80, 0, 2),"goodMeson_threemass", "scale")
hBKG = dg.Define("scale", "w*lumiIntegrated").Histo1D(("hist", "#phi three mass, reconstruction", 80, 0, 2),"goodMeson_threemass", "scale")
