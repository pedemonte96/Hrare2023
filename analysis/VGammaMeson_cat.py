...
#                  .Define("goodMeson_bestVtx_Z", "rho_bestVtx_Z[goodMeson]")
        ...
        if(isData == "false"):
            dfbase = (dfbase
                ...
                #.Define("goodMeson_phi_GEN", "get3BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 111, 223, 25).phi()")
                #.Define("goodMeson_mass_GEN", "get3BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 111, 223, 25).M()")
                .Define("goodMeson_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 223, 25).pt()")
                .Define("goodMeson_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 223, 25).eta()")
                .Define("goodMeson_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 223, 25).phi()")
                .Define("goodMeson_mass_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 223, 25).M()")
                .Define("goodMeson_ditrk_pt_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 223, 25).pt()")
                .Define("goodMeson_ditrk_eta_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 223, 25).eta()")
                .Define("goodMeson_ditrk_phi_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 223, 25).phi()")
                .Define("goodMeson_ditrk_mass_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 223, 25).M()")
                ...
                .Define("goodMeson_photon1_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 223, 25).pt()")
                .Define("goodMeson_photon1_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 223, 25).eta()")
                .Define("goodMeson_photon1_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 223, 25).phi()")
        ...
        if(isData == "false"):
            dfbase = (dfbase.Define("goodMeson_pt_GEN", "get3BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 111, 333, 25).pt()")
                ...
                .Define("goodMeson_mass_GEN", "get3BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 111, 333, 25).M()")
                .Define("goodMeson_ditrk_pt_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 333, 25).pt()")
                .Define("goodMeson_ditrk_eta_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 333, 25).eta()")
                .Define("goodMeson_ditrk_phi_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 333, 25).phi()")
                .Define("goodMeson_ditrk_mass_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -211, 211, 333, 25).M()")
                ...
                .Define("delta_eta_goodMeson_ditrk_goodPhoton_GEN", "goodMeson_ditrk_eta_GEN - goodPhotons_eta_GEN")
                .Define("delta_phi_goodMeson_ditrk_goodPhoton_GEN", "std::fmod((goodMeson_ditrk_phi_GEN - goodPhotons_phi_GEN + 4*M_PI), 2*M_PI)")
                .Define("goodMeson_photon1_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 333, 25).pt()")
                .Define("goodMeson_photon1_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 333, 25).eta()")
                .Define("goodMeson_photon1_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 333, 25).phi()")
                .Define("goodMeson_photon1_DR_GEN", "ROOT::VecOps::DeltaR(goodMeson_ditrk_eta_GEN, goodMeson_photon1_eta_GEN, goodMeson_ditrk_phi_GEN, goodMeson_photon1_phi_GEN)")
                .Define("goodMeson_photon2_pt_GEN", "-1.0")
                .Define("goodMeson_photon2_eta_GEN", "-1.0")
                .Define("goodMeson_photon2_phi_GEN", "-1.0")
        ...
        if(isData == "false"):
            dfbase = (dfbase.Define("goodMeson_pt_GEN", "getD0StarPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother).pt()")
                ...
                .Define("goodMeson_mass_GEN", "getD0StarPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother).M()")
                .Define("goodMeson_ditrk_pt_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -321, 211, 421, 423, 25).pt()")
                .Define("goodMeson_ditrk_eta_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -321, 211, 421, 423, 25).eta()")
                .Define("goodMeson_ditrk_phi_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -321, 211, 421, 423, 25).phi()")
                .Define("goodMeson_ditrk_mass_GEN", "get2BodyPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, -321, 211, 421, 423, 25).M()")
                ...
                .Define("delta_eta_goodMeson_ditrk_goodPhoton_GEN", "goodMeson_ditrk_eta_GEN - goodPhotons_eta_GEN")
                .Define("delta_phi_goodMeson_ditrk_goodPhoton_GEN", "std::fmod((goodMeson_ditrk_phi_GEN - goodPhotons_phi_GEN + 4*M_PI), 2*M_PI)")
                .Define("goodMeson_photon1_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 423, 25).pt()")
                .Define("goodMeson_photon1_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 423, 25).eta()")
                .Define("goodMeson_photon1_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 423, 25).phi()")
                .Define("goodMeson_photon1_DR_GEN", "ROOT::VecOps::DeltaR(goodMeson_ditrk_eta_GEN, goodMeson_photon1_eta_GEN, goodMeson_ditrk_phi_GEN, goodMeson_photon1_phi_GEN)")
                .Define("goodMeson_photon2_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 22, 423, 25).pt()")
                .Define("goodMeson_photon2_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 22, 423, 25).eta()")
                .Define("goodMeson_photon2_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 22, 423, 25).phi()")
                ...
                .Define("goodMeson_photon3_pt_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 421, 423, 25).pt()")
                .Define("goodMeson_photon3_eta_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 421, 423, 25).eta()")
                .Define("goodMeson_photon3_phi_GEN", "getPtEtaPhiM(GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass, GenPart_pdgId, GenPart_genPartIdxMother, 111, 421, 423, 25).phi()")
